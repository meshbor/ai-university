...
export const THEMES: Record<ThemeId, ThemeConfig> = {
  light: {
    ...
    who: 'Игрок: Baruh',
    tabs: { special: 'Характеристики', skills: 'Курсы', duels: 'Дуэли' },
  ...
  fallout: {
    ...
    tabs: { special: 'S.P.E.C.I.A.L.', skills: 'SKILLS', duels: 'VS DUELS' },
  ...
  space: {
    ...
    tabs: { special: 'Системы корабля', skills: 'Курсы', duels: 'Дуэли' },
  ...
  wot: {
    ...
    tabs: { special: 'Экипаж', skills: 'Курсы', duels: 'Поединки' },
  ...
  knight: {
    ...
    tabs: { special: 'Доблесть', skills: 'Курсы', duels: 'Турнир' },
  ...
  samurai: {
    ...
    tabs: { special: 'Бусидо', skills: 'Курсы', duels: 'Схватки' },
